...
For write operations, always verify actual data changes:
- Check `writeResult.writeTime` changes after operations
- Compare `snapshot.data()` before/after to confirm modification
